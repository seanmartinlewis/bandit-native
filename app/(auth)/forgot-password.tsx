    ...
    >
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View className="flex-1 items-center justify-center px-8">
          ...
          <Text className="font-redhat-semibold text-2xl text-gray-900 dark:text-orange-100 mb-2">
            Reset Password
          </Text>
          ...
          {sent ? (
            <View className="items-center">
              ...
              <Link href="/(auth)/login" className="text-bandit-primary dark:text-bandit-primarySoft">
                Back to Login
              </Link>
            </View>
          ) : (
            <View className="w-full space-y-4">
              ...
              <View className="flex-row justify-center mt-2">
                <Link href="/(auth)/login" className="text-sm text-bandit-primary dark:text-bandit-primarySoft">
                  Back to Login
                </Link>
              </View>
            </View>
